...
import { InsufficienteParamaters, InternalNonceError, InvalidCredentialRequest, InvalidDataProvided, InvalidToken } from "../../common/classes/index.js";
    ...
    generateCredentialResponse(acessToken, credentialRequest, dataModel, optionalParamaters) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (credentialDataOrDeferred.deferredCode) {
                ...
                throw new InternalNonceError("No credential data or deferred code received");
            }
        });
    }
