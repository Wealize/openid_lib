...
import { CredentialAdditionalVerification, NonceAndStateVerification, VpExtractedData } from "../presentations/types.js";
...
export declare class OpenIDReliyingParty {
     ...
     * @throws If data provided is incorrect
     */
    verifyVpTokenResponse(vpTokenResponse: VpTokenResponse, presentationDefinition: DIFPresentationDefinition, nonceVerificationCallback: NonceAndStateVerification, vcSignatureVerification?: boolean): Promise<VerifiedVpTokenResponse>;
    /**
